...
## This function looks for and finds the desired file. You can specify a parent directory for the fundtion to look for.
...
cartoon_style_selection = input("There are 2 styles. Please type 1 or 2.   ")
